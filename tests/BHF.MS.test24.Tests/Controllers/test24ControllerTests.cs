using BHF.MS.test24.Controllers;
using BHF.MS.test24.Models;
using BHF.MS.test24.Services;
using FluentAssertions;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.Logging;
using Moq;

namespace BHF.MS.test24.Tests.Controllers
{
    public class test24ControllerTests
    {
        private readonly Mock<ILogger<test24Controller>> _loggerMock = new();
        private readonly Mock<IExampleService> _exampleServiceMock = new();
        private readonly test24Controller _sut;

        public test24ControllerTests()
        {
            _sut = new test24Controller(_loggerMock.Object, _exampleServiceMock.Object);
        }
